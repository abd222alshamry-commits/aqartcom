...
const typeMap=[['شقة',['شقه','شقق']],['فيلا',['فيلا','فلل']],['منزل',['منزل','بيت','بيوت']],['أرض',['ارض','اراضي']],['مزرعة',['مزرعه','مزارع']],['محل تجاري',['محل','محلات']],['مكتب',['مكتب','مكاتب']],['بناء',['بناء','ابنيه']],['hotel',['فندق','فنادق']],['furnished_apartment',['مفروشه']],['farm',['مزرعه','مزارع']]];
function parse(message,preferences={}){
 ...
 if(/فندق|فنادق|اقامه|حجز/.test(q))f.kind='hotel';
