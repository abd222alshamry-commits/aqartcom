...
function filters(){return{availability:'unconfirmed',city:$('#city').value,district:$('#district').value.trim(),mode:$('#mode').value,type:$('#type').value,minPrice:$('#minPrice').value,maxPrice:$('#maxPrice').value,rooms:$('#rooms').value}}
